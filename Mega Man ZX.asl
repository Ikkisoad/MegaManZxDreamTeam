...
{
    uint IGT : "DeSmuME_0.9.11_x64.exe", 0x55714F8;
	byte bossHP : "DeSmuME_0.9.11_x64.exe", 0x55622FA;
	byte room : "DeSmuME_0.9.11_x64.exe", 0x5523DB5;
}

state("DeSmuME_0.9.11_x86")
{
    uint IGT : "DeSmuME_0.9.11_x86.exe", 0x3001160;
	byte bossHP : "DeSmuME_0.9.11_x86.exe", 0x2FF1F62;
	byte room : "DeSmuME_0.9.11_x86.exe", 0x4ED0949;
}
